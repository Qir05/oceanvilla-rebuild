...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "About", item: "https://oceanvillasturtlebay.com/about" },
  ],
};
      ...
      <section className="bg-slate-900 py-16 text-center">
        <div className="mx-auto max-w-2xl px-6">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/availability" className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-100 transition">
              Search Availability
            </Link>
