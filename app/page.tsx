    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative">
        ...
        <div className="relative h-[78vh] min-h-[520px] w-full overflow-hidden">
          ...
          {/* BOOKING BAR (CENTERED like reference) */}
          <div
            id="availability"
            className="absolute left-1/2 top-[56%] w-[min(100%,980px)] -translate-x-1/2 px-4"
          >
            <div className="rounded-md bg-white/85 shadow-lg backdrop-blur">
              <div className="grid gap-0 overflow-hidden rounded-md md:grid-cols-[1.1fr_1.1fr_1.1fr_1fr_1fr_160px]">
                {/* Arrival */}
...
<div className="border-b border-slate-200 p-3 md:border-b-0 md:border-r">
  ...
  <select className="mt-1 h-9 w-full bg-transparent text-sm outline-none">
    ...
    <option value="5">5 days</option>
                ...
                {/* Search */}
                <button className="h-full min-h-[54px] bg-teal-600 text-sm font-medium text-white hover:bg-teal-700">
                  Search
                </button>
              </div>
            </div>
